...
> **来源**: 本项目为第三方开源项目，基于 [DETR 论文](https://arxiv.org/abs/2005.12872) (End-to-End Object Detection with Transformers, Meta AI, ECCV 2020) 和 [Conditional DETR 论文](https://arxiv.org/abs/2108.06152) 实现，提供了 DETR/Conditional DETR 在自定义 COCO 数据集上的训练、微调和评测框架。
